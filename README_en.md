...
Current version: **v1.2.8 (released)**
...
The v1.2.8 Windows/macOS installers passed qualification across three architectures and are published. The DSH plugin tarball remains available in the v1.2.0 Release; npm publication remains out of scope.
