...
Current version: **v1.2.10 (qualification in progress)**
...
The v1.2.10 Windows x64, macOS Apple Silicon, and macOS Intel installers are undergoing qualification. After qualification, the installers will be available in one GitHub Release. The DSH plugin tarball remains available in the v1.2.0 Release; npm publication remains out of scope.

[Download v1.2.10](https://github.com/shuishuipingan/InkWeaver/releases/tag/v1.2.10) · [Start your first chapter in three minutes](docs/quickstart/README.md) · [Install the DSH plugin](plugins/inkweaver-dsh/README.md) · [Ask a question or report a problem](https://github.com/shuishuipingan/InkWeaver/issues/new/choose) · [Join the discussion](https://github.com/shuishuipingan/InkWeaver/discussions)
...
The current macOS installers do not have a Developer ID signature and are not notarized. After v1.2.10 qualification, download only from its formal Release and follow the operating system's first-launch confirmation. The desktop Release uses a seven-asset contract covering macOS Apple Silicon and macOS Intel; the DSH plugin tarball remains in the v1.2.0 Release.
