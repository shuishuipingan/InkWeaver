...
The v1.2.6 Windows/macOS installers will be published after qualification. The DSH plugin tarball remains available in the v1.2.0 Release; npm publication remains out of scope.
