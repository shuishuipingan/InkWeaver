...
- [x] **Step 3: Implement the path-only classifier and CLI**
...
- [x] **Step 4: Run tests and the pre-clean inventory**
...
- [x] **Step 5: Verify screenshot references before deletion**
...
- [x] **Step 6: Update ignore rules and the compatibility README**
...
- [x] **Step 7: Remove only validated generated files and rerun hygiene**
...
- [x] **Step 8: Commit the hygiene task**
...
- [x] **Step 1: Add the SVG flow asset**
...
- [x] **Step 2: Rewrite the Chinese README first screen**
...
- [x] **Step 3: Mirror the structure in README_en.md**
...
- [x] **Step 4: Add link and Markdown contract tests**
...
- [x] **Step 5: Run the documentation tests**
...
- [x] **Step 6: Commit the homepage task**
...
- [x] **Step 1: Write quickstart acceptance tests**
...
- [x] **Step 3: Write the smallest complete quickstart**
...
- [x] **Step 4: Add the example assets**
...
- [x] **Step 5: Run the contract and link checks**

  Run: `pnpm exec vitest run scripts/__tests__/quickstart-contract.test.ts --maxWorkers=1`

  Run: `node scripts/check-i18n-coverage.mjs`

- [x] **Step 6: Commit the quickstart task**
...
- [x] **Step 4: Enable Discussions through the GitHub API**
...
- [x] **Step 5: Run local template/link checks and commit**
...
- [x] **Step 1: Write deterministic parser tests**
...
- [x] **Step 3: Implement the read-only CLI**
...
- [x] **Step 7: Verify release immutability and remote state**
...
- [x] **Step 8: Write the acceptance receipt and commit**
