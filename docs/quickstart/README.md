...
最简单的方式是从 [v1.2.12 GitHub Release](https://github.com/shuishuipingan/InkWeaver/releases/tag/v1.2.12) 下载对应系统的安装包：

- Windows x64：`inkweaver-setup-1.2.12.exe`
- macOS Apple Silicon：`inkweaver-mac-arm64-1.2.12-installer.dmg`
- macOS Intel：`inkweaver-mac-x64-1.2.12-installer.dmg`
