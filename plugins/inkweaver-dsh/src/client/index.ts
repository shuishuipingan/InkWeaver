...
export function apply(ctx: ClientContext): void {
  ...
  }, 'inkweaver: setup and context lifecycle')
  if (typeof document !== 'undefined') {
    ctx.effect(() => installNovelContextStyle(document), 'inkweaver: context-window styles')
  }
  ...
  }, 'inkweaver: observe and refresh Host connection')
