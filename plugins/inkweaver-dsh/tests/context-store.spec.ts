...
describe('novel context client state', () => {
  it('inspects a selected workspace while closed, follows changes, and selects chapters without polling', async () => {
    ...
    controller.setTarget({ workspaceId: WORKSPACE_A, sessionId: SESSION_A, agentPreset: 'inkweaver', approval: 'ask' })
    ...
    controller.setTarget({ workspaceId: WORKSPACE_B, sessionId: SESSION_B, agentPreset: 'inkweaver', approval: 'ask' })
    await controller.whenIdle()
