...
export default function AgentInputBox() {
  ...
  return (
    ...
    >
      ...
      {showContextMenu && (
        <div
          className="ctx-menu anim-scale-in absolute bottom-[calc(100%+8px)] left-0 z-50 py-1 rounded-lg shadow-lg"
          style={{
            width: 180,
        ...
        <div className="flex items-center gap-0.5 min-w-0 flex-1">
          ...
          <div ref={modeRef} className="relative">
            <button
              ...
              className="flex items-center gap-0.5 py-1 pl-1 pr-1.5 rounded-md text-xs transition-colors hover:bg-[var(--color-hover)] hover:opacity-100"
              style={{
            ...
            {showModeMenu && (
              <div
                className="ctx-menu anim-scale-in absolute bottom-full left-0 mb-1 z-50 py-1 rounded-lg shadow-lg"
                style={{
                  width: 240,
                  backgroundColor: 'var(--color-popover-bg)',
                  border: '1px solid var(--color-border)',
          ...
          <div ref={modelRef} className="relative min-w-0">
            <button
              ...
              className="flex items-center gap-0.5 py-1 pl-0.5 pr-1.5 rounded-md text-xs min-w-0 transition-colors hover:bg-[var(--color-hover)] hover:opacity-100"
              style={{
                color: 'var(--color-text-secondary)',
                opacity: 0.75,
                maxWidth: 140,
...
function ToolbarIconBtn({
  ...
  return (
    <button
      title={title}
      onClick={onClick}
      className="flex items-center justify-center p-1 rounded-full transition-colors hover:bg-[var(--color-hover)] hover:opacity-100"
...
function ContextMenuItem({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="w-full flex items-center gap-2 px-3 py-1.5 text-xs transition-colors enabled:hover:bg-[var(--color-hover)]"
      style={{
...
function ModeMenuItem({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex flex-col items-start gap-0.5 px-3 py-2 text-left text-xs transition-colors rounded-md mx-1 hover:bg-[var(--color-hover)]"
      style={{
        width: 'calc(100% - 8px)',
