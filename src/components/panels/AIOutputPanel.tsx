      ...
      {isActive && canCancel && (
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10">
          <button
            ...
            className="ai-cancel-button flex items-center justify-center gap-1.5 text-xs px-3 py-1.5 rounded-full transition-all shadow-md backdrop-blur-md"
          >
            <StopCircle size={13} />
  ...
  return (
    <div className="mb-0.5">
      ...
      <button
        ...
        className="group flex items-center gap-1.5 w-full text-left text-xs min-h-6 py-1 select-none transition-colors hover:text-[var(--color-text)]"
      ...
      <div className="flex flex-col gap-0.5">
        {items.map(run => (
          <button
            ...
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-left transition-colors hover:bg-[var(--color-hover)]"
          >
