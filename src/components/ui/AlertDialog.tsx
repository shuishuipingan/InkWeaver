...
/**
 * InkWeaver 弹窗报错组件 — JetBrains / VSCode 风格
 *
 ...
 *   alertError('不是有效的 InkWeaver 项目目录', { title: '打开项目失败' })
 */
      ...
      <div
        ...
        style={{
          ...
          /* CSS 动画，使用 both 从而提前应用 0% 关键帧，彻底杜绝闪烁现象。
             注意：时长与缓动必须分开写，复合值（--motion-*）会被解析为 animation-delay */
          animation: isExiting
            ? 'dialog-exit var(--dur-fast) var(--ease-exit) both'
            : 'dialog-enter var(--dur-slow) var(--ease-spring) both',
        }}
 ...
 *
 * @example
 * await alertError('不是有效的 InkWeaver 项目目录', { title: '打开项目失败' })
