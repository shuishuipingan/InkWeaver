...
export function ContextMenu({ items, position, onClose }: ContextMenuProps) {
  ...
  return (
    <div
      ref={menuRef}
      className={`fixed z-[var(--z-popover)] py-1 select-none ctx-menu ${closing ? 'anim-scale-out' : 'anim-scale-in'}`}
      style={{
        left,
        top,
        minWidth: MENU_W,
      ...
      {items.map(entry => {
        ...
        return (
          <button
            ...
            className="ctx-menu-item w-full flex items-center gap-2 px-3 py-1.5 text-left"
            style={{
              color: item.disabled
